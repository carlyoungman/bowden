...
<li>
  <div <?php post_class( $classes ); ?>>
    ...
    <div class="row">
      <a class="col-md-6 full-width" href="<?php the_permalink(); ?>">
        <div class="thumbnail">
      ...
      <?php if ( is_page( 'Properties Shortlist' ) ): ?>
      <div class="col-md-5 full-width">
        ...
        <?php
        if ( is_page( 'Properties Shortlist' ) ): ?>
          <div class="col">
            <a class="remove-from-shortlist" href="add-to-shortlist" data-property="<?php echo the_ID(); ?>">
              <p>Remove</p>
            </a>
          </div>
        <?php endif; ?>
