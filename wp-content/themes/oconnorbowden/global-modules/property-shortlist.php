...
global $property;
?>
<ul class="property-shortlist">
  <li class="action-shortlist"><a href="add-to-shortlist" rel="nofollow">
      <svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 96 960 960">
        <path
